...
export default function ListingCard({ listing }) {
  ...
  useEffect(() => {
    const checkIfFavorite = async () => {
      const response = await checkIsFavorited(listing.id);
      if (response) {
    ...
    <Card className="overflow-hidden hover:shadow-md transition-shadow duration-300 group">
        <div className="relative">
          ...
          <div className="relative h-56 bg-gray-100">
            ...
            <FavorisButton offerId={listing.id} isFavorited={isFavorite} />
          ...
          <CardContent className="p-4 space-y-3">
            ...
            <div className="text-lg font-semibold flex items-center tracking-tighter">
              ...
              <span className="text-sm ml-1 font-normal text-gray-500">/mois</span>{" "}
              <Badge
                variant="outline"
