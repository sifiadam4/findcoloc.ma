...
export function ImageUpload({ value = [], onChange, maxFiles = 8 }) {
  const maxSizeMB = 5
  const maxSize = maxSizeMB * 1024 * 1024 // 5MB

  // Convert existing URLs to file objects for the hook
  ...
  const [
    ...
    onFilesChange: (updatedFiles) => {
      // Convert files back to URLs for the form
      ...
      <div
        ...
        {files.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="mb-1.5 text-sm font-medium">Glissez-déposez vos images ici</p>
